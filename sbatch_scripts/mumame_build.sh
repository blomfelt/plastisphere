...
INDIR=/cephyr/NOBACKUP/groups/jbp-mv-waters/felix/card-data-3.1.4/;

# Output directory
OUTDIR=/cephyr/NOBACKUP/groups/jbp-mv-waters/felix/Mumame_test;
...
apptainer exec $CONTAINER_LOC mumame_build -i protein_fasta_protein_variant_model.fasta -m snps.txt -d 16 -o "mutation_database_3.1.4"
